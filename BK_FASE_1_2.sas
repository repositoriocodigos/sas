...
%MACRO OpCobrancaM(ANOMES,ANOMES_M1);
...
PROC EXPORT DATA=workbck.OpFase1_&ANOMES
   OUTFILE="C:\Users\Di Giunta\Documents\GoOn\Nextel\01 Planilha\02 Operacional Cobrança\Operacional Fase1_&ANOMES..txt"
   DBMS=TAB REPLACE;
RUN;
...
PROC EXPORT DATA=workbck.OpFase2_&ANOMES
   OUTFILE="C:\Users\Di Giunta\Documents\GoOn\Nextel\01 Planilha\02 Operacional Cobrança\Operacional Fase2_&ANOMES..txt"
   DBMS=TAB REPLACE;
RUN;
